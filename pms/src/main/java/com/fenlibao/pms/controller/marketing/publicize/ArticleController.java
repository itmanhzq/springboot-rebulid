...
public class ArticleController {
    ...
    public Response<Boolean> addArticle(@ApiIgnore @CurrentUser UserPrincipal currentUser,
                                      @RequestBody @Valid ArticleAddReq essayAddReq) {
    ...
    @ApiResponse(code = 200, message = "请求成功", response = Boolean.class)
    public Response<Boolean> updateArticle(@ApiIgnore @CurrentUser UserPrincipal currentUser,
                                         @RequestBody @Valid ArticleUpdateReq essayUpdateReq) {
        return Response.ok();
    }
    ...
    @PreAuthorize("hasPermission('article','update')")
    @ApiResponse(code = 200, message = "请求成功", response = Boolean.class)
    public Response<Boolean> topPlaceArticle(@ApiIgnore @CurrentUser UserPrincipal currentUser,
                                              @RequestBody @Valid ArticleStickTopReq bulletinUpdateReq) {
